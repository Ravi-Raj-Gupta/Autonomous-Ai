    ...
    "inventory": [
        {
            ...
            "vendorEmail": "orders@premium-supplies.com",
            "vendorPhone": "+91 9876543210",  # Replace with actual vendor phone
        ...
        },
        {
            ...
            "reorderPoint": 15,
            "price": 12.00,
            "vendor": "Tea Imports Ltd",
            "vendorEmail": "sales@teaimports.com",
            "vendorPhone": "+91 9876543211",  # Replace with actual vendor phone
            ...
            if "smsStatus" in decision:
                ...
                if sms['success']:
                    if sms.get('simulated'):
                        print("⚠️  SMS simulated (not actually sent)")
                    else:
